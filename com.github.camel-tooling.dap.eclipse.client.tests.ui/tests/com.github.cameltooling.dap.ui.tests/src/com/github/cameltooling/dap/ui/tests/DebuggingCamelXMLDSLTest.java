...
public class DebuggingCamelXMLDSLTest {
	...
	public static void setupTestEnvironment() {
		DefaultEditorDialog.setDefault("*.xml", GTE);

		ImportIntoWorkspace.importFolder(PROJECT_FOLDER_PATH);

		RunConfigurationDialog.createMaven(MVN_CONF, "${workspace_loc:/main-xml}");
...
//	}
	 ...
	 */
	@Test
	public void XMLDSLTest() {

		// Open file with camel route.
		ProjectExplorer explorer = new ProjectExplorer();
		explorer.open();
		ProjectItem routeFile = explorer.getProject("main-xml").getProjectItem("src", "main", "resources", "routes",
				"my-route.xml");
		routeFile.open();
